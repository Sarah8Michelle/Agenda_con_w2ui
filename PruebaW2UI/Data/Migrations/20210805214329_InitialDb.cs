            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    PersonId = table.Column<int>(nullable: false),
                    Code = table.Column<string>(maxLength: 56, nullable: false),
                    OrderDate = table.Column<DateTime>(nullable: false),
                    ArrivalDate = table.Column<DateTime>(nullable: false),
                    ShipCompany = table.Column<string>(maxLength: 128, nullable: false),
                    ShipAddress = table.Column<string>(maxLength: 256, nullable: true),
                    ShipCity = table.Column<string>(maxLength: 128, nullable: true),
                    ShipRegion = table.Column<string>(maxLength: 128, nullable: true),
                    ShipPostalCode = table.Column<string>(maxLength: 10, nullable: true),
                    ShipCountry = table.Column<string>(maxLength: 60, nullable: true)
                },
                constraints: table =>
                {
